    ...
    <div className="rounded-xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900 space-y-6">
      ...
      >
        ...
        <p className="mt-1 text-sm text-slate-500">
          or <span className="font-semibold text-blue-600 dark:text-blue-400 hover:underline">browse from your computer</span>
        </p>
      ...
      {selectedFile && (
        <div className="space-y-4">
          <h4 className="text-xs font-bold text-slate-700 dark:text-slate-300">Uploaded Files</h4>
      ...
      <div className="flex items-start space-x-3 rounded-xl bg-blue-50/70 p-4 dark:bg-blue-950/40 border border-blue-100 dark:border-blue-900">
        ...
        <div>
          ...
          <p className="text-xs text-blue-700 dark:text-blue-300 mt-0.5">
            Your CV data will be automatically extracted, read, and structured into employee fields. This may take a few moments.
          </p>
        </div>
      </div>
